...
//     await fetch("http://localhost:5000/api/admin/user/disable", {
//       method: "POST",
...
//     await fetch("http://localhost:5000/api/admin/user/upgrade", {
//       method: "POST",
//       headers: { "Content-Type": "application/json" },
//       body: JSON.stringify({ userId: id, plan: "Pro" }),
//     });
//     fetchStats();
//   };
...
//                       <Pie
//                         data={[
//                           { name: "Images", value: stats.storageBreakdown?.images || 0 },
//                           { name: "Videos", value: stats.storageBreakdown?.videos || 0 },
//                           { name: "Docs", value: stats.storageBreakdown?.docs || 0 },
//                           { name: "Others", value: stats.storageBreakdown?.others || 0 },
//                         ]}
//                         innerRadius={60}
//                         outerRadius={80}
//                         paddingAngle={8}
...
//                             {user.isDisabled ? "Terminated" : user.plan}
//                           </span>
//                         </td>
...
//                             <button onClick={() => disableUser(user._id)} className="px-4 py-1.5 rounded-lg bg-red-500/10 text-red-500 text-xs font-bold hover:bg-red-500 hover:text-white transition-all">Restrict</button>
//                           </div>
//                         </td>
//                       </tr>
//                     ))}
...
//                   <h3 className="text-lg font-semibold mb-6 self-start">User Activity Breakdown</h3>
...
//                   <h3 className="text-lg font-semibold mb-6">Top Users by Storage</h3>
